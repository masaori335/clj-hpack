...
(deftest D.2.1
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      (is (= (decode! table [0x40 0x0a 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x6b 0x65 0x79 0x0d 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x68 0x65 0x61 0x64 0x65 0x72])
...
(deftest D.2.2
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      (is (= (decode! table [0x04 0x0c 0x2f 0x73 0x61 0x6d 0x70 0x6c 0x65 0x2f 0x70 0x61 0x74 0x68])
             [[":path" "/sample/path"]])))))
...
(deftest D.2.3
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      (is (= (decode! table [0x10 0x08 0x70 0x61 0x73 0x73 0x77 0x6f 0x72 0x64 0x06 0x73 0x65 0x63 0x72 0x65 0x74])
             [["password" "secret"]])))))
...
(deftest D.3.1
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      (is (= (decode! table [0x82 0x86 0x84 0x41 0x0f 0x77 0x77 0x77 0x2e 0x65 0x78 0x61 0x6d 0x70 0x6c 0x65 0x2e 0x63 0x6f 0x6d])
...
(deftest D.3.2
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      (is (= (decode! table [0x82 0x86 0x84 0x41 0x0f 0x77 0x77 0x77 0x2e 0x65 0x78 0x61 0x6d 0x70 0x6c 0x65 0x2e 0x63 0x6f 0x6d])
             [[":method" "GET"] [":scheme" "http"] [":path" "/"] [":authority" "www.example.com"]]))
      (is (= (decode! table [0x82 0x86 0x84 0xbe 0x58 0x08 0x6e 0x6f 0x2d 0x63 0x61 0x63 0x68 0x65])
...
(deftest D.3.3
  ...
  (testing ""
    (let [table (HeaderTable. '())]
      ...
      (is (= (decode! table [0x82 0x86 0x84 0xbe 0x58 0x08 0x6e 0x6f 0x2d 0x63 0x61 0x63 0x68 0x65])
             [[":method" "GET"] [":scheme" "http"] [":path" "/"] [":authority" "www.example.com"] ["cache-control" "no-cache"]]))
      (is (= (decode! table [0x82 0x87 0x85 0xbf 0x40 0x0a 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x6b 0x65 0x79 0x0c 0x63 0x75 0x73 0x74 0x6f 0x6d 0x2d 0x76 0x61 0x6c 0x75 0x65])
